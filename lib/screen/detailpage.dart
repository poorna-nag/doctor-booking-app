...
// import 'package:ecoshine24/screen/detailpage1.dart';
...
//     });
//     catby_productData(
//             catid!.length > 0 ? catid![0] : "0", "0", widget.plist.mv ?? "")
//         .then((usersFromServe) {
//       setState(() {
...
//                                   const EdgeInsets.only(top: 2.0, bottom: 1),
//                               child: Text(
//                                   '\u{20B9} ${(totalmrp! * _count).toStringAsFixed(FoodAppConstant.val)}',
